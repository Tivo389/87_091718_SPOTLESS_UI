...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (waterForms) {
    for (const waterForm of waterForms) {
      ...
      const svgTriangle = `
        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
          <path fill="#676767" fill-rule="evenodd" d="M5.38411064,2.46093277 L9.31658983,7.1799078 C9.49337187,7.39204625 9.46470984,7.7073286 9.25257139,7.88411064 C9.16271389,7.95899189 9.04944745,8 8.93247919,8 L1.06752081,8 C0.791378431,8 0.567520806,7.77614237 0.567520806,7.5 C0.567520806,7.38303175 0.608528916,7.2697653 0.683410167,7.1799078 L4.61588936,2.46093277 C4.7926714,2.24879432 5.10795375,2.22013229 5.3200922,2.39691433 C5.34332373,2.41627394 5.36475103,2.43770124 5.38411064,2.46093277 Z"/>
        </svg>
      `;
      ...
      const addWater = (el) => {
        ...
        const inputTypeNumber = () => {
          ...
          wrapper.insertAdjacentHTML( "beforeend", `
            <span class="stepperUp">${svgTriangle}</span>
            <span class="stepperDown">${svgTriangle}</span>
          `);
          // CONTINUE HERE MAKE CSS FOR THESE
          // addRequirementSymbol(el);
        };
