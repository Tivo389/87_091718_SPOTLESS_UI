...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (waterForm) {
    ...
    // - <element> / Perform a simple validation for all the inputs.
    ...
    // - <element required> / Add an asterisk to any input with a 'required' attribute
    ...
    allInputs.forEach(input => {addWater(input)});
  }
  //-----------------------------------------------------------------------------------------------
});
